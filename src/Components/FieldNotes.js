            ...
            <section id="fieldnotes">
                <div className="row projects">
                    <div className="twelve columns collapsed">
                        <h1>Not every idea becomes a full project — this section shares quick explorations, blog posts, and topics I’m curious about.</h1>
                        <div id="fieldnotes-wrapper" className="bgrid-quarters s-bgrid-thirds cf">
                            ...
                            <div className="article-wrapper">
                                ...
                                <ul className="actions">
                                    <li className="wide-button"><a href="https://github.com/EvanHofmeister"
                                                                   className="button fieldnotes-button" target="_blank"
                                                                   rel="noopener noreferrer">Full FieldNotes</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
